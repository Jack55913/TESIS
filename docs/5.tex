...
% \subsubsection*{TRL 1: Principios Básicos Observados y Reportados}

% \begin{enumerate}
%   \item \textbf{¿Finalizó con la investigación básica de su idea?} \\
%   \textbf{Sí.} Se realizó una revisión teórica del problema del monitoreo comunitario y sus posibles soluciones digitales aplicadas en contextos rurales, incluyendo técnicas participativas y modelos de monitoreo, detalladas en el capítulo \ref{cap:3}.

%   \item \textbf{¿Identificó principios de investigación básica que pudieran trasladarse en principios nuevos que puedan ser utilizados en nuevas tecnologías?} \\
%   \textbf{Sí.} Se adaptaron conceptos de ciencia ciudadana, gobernanza forestal y manejo integral del agua hacia el desarrollo de una aplicación móvil comunitaria.

%   \item \textbf{¿Realizó un análisis de los artículos científicos, modelos o teorías científicas que respaldan la aplicación de la idea en algún área tecnológica?} \\
%   \textbf{Sí.} Se citaron y analizaron más de 30 fuentes científicas sobre sensores de lluvia, ciencia participativa, software de monitoreo ambiental, y tecnologías libres para comunidades.

% \end{enumerate}

% \subsubsection*{TRL 2-3: Formulación del Concepto Tecnológico y Validación Experimental Inicial}

% \begin{enumerate}
%   \item \textbf{¿Ha explorado principios básicos de manufacturabilidad?} \\
%   \textbf{Sí.} Se desarrolló un prototipo de pluviómetro artesanal, y se consideraron alternativas de fabricación económica en contextos rurales.

%   \item \textbf{¿Ha explorado posibles usuarios de la invención?} \\
%   \textbf{Sí.} Se identificaron actores clave como ejidatarios, técnicos forestales, senderistas y brigadistas, mediante entrevistas y talleres.

%   \item \textbf{¿Cuenta con un grupo de investigación que pueda facilitar la evaluación inicial de factibilidad de la tecnología?} \\
%   \textbf{Sí.} Se contó con el respaldo técnico de instituciones como la Universidad Autónoma Chapingo y la comunidad científica del proyecto Miyotl.

%   \item \textbf{¿Tiene identificados los componentes de su invención tecnológica?} \\
%   \textbf{Sí.} Se definieron módulos principales: sensores, aplicación móvil, sistema de almacenamiento y visualización de datos.

%   \item \textbf{¿Ha llevado a cabo algún proceso de validación de mercado sobre su invención?} \\
%   \textbf{Sí.} Se realizaron pruebas con usuarios reales en campañas de monitoreo durante 2023-2024 en comunidades del estado de México.

% \end{enumerate}

% \subsubsection*{TRL 4-5: Validación de Componentes Tecnológicos en Laboratorio}

% \begin{enumerate}
%   \item \textbf{¿Ha integrado los componentes principales de su invención tecnológica?} \\
%   \textbf{Sí.} Se desarrolló un sistema funcional que incluye captura de datos, análisis, exportación, autenticación de usuarios y visualización de gráficos.

%   \item \textbf{¿Ha realizado pruebas de validación de efectividad de dicha invención en laboratorio?} \\
%   \textbf{Sí.} Se probó el sistema con mediciones simuladas y reales, comparando valores, identificando errores y mejorando la interfaz.

%   \item \textbf{¿Ha continuado la validación de mercado con más entrevistas con usuarios potenciales y estudios de mercado?} \\
%   \textbf{Sí.} Durante múltiples campañas de difusión y talleres, se evaluó la aceptación del sistema, obteniendo retroalimentación valiosa.

%   \item \textbf{¿Su invención tecnológica funciona a nivel laboratorio?} \\
%   \textbf{Sí.} El prototipo está completamente funcional a nivel digital y técnico, demostrando precisión y confiabilidad en pruebas internas.

% \end{enumerate}

% \subsubsection*{TRL 6: Demostración del Sistema en Entorno Relevante}

% \begin{enumerate}
%   \item \textbf{¿Ha probado su prototipo en laboratorio en condiciones de un ambiente real?} \\
%   \textbf{Sí.} El sistema fue desplegado en zonas rurales con acceso limitado a internet, mostrando buen desempeño y adaptabilidad.

%   \item \textbf{¿Tiene plenamente identificadas y considerados aspectos de manufacturabilidad del futuro producto?} \\
%   \textbf{Sí.} Se documentó un modelo técnico de instalación del pluviómetro y los requerimientos mínimos de hardware/software para el sistema.

%   \item \textbf{¿Cuenta con usuarios potenciales que prueben la versión final del producto?} \\
%   \textbf{Sí.} Ejidatarios y técnicos han usado la aplicación en campañas reales, generando reportes útiles para la comunidad.

% \end{enumerate}

% \subsubsection*{TRL 7 en adelante: Producción Piloto y Comercialización}

% \begin{enumerate}
%   \item \textbf{¿Cuenta con un producto terminado para prueba de primeros clientes?} \\
%   \textbf{Sí.} La aplicación está disponible en GitHub y ha sido instalada por usuarios reales, quienes han reportado mediciones verificadas.

%   \item \textbf{¿Se encuentra manufacturando el producto en su versión final?} \\
%   \textbf{No.} Aún no se ha iniciado una manufactura a gran escala de sensores físicos o una distribución formal.

%   \item \textbf{¿Tiene un producto comercializable?} \\
%   \textbf{No.} El enfoque es de libre acceso y sin fines comerciales, aunque puede derivarse en servicios o asesorías.

%   \item \textbf{¿Su organización es operativa al 100\%?} \\
%   \textbf{No.} El equipo es limitado y depende de colaboración voluntaria y recursos institucionales o de investigación.
